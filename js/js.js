...
async function getCategories() {
    ...
    showCateg(response.categories)
    $(".inner-loading-screen").fadeOut(300)

}

function showCateg(arr) {
    let cartoona = "";
...
async function getMealDetails(mealID) {
    ...
    showMealsInfo(respone.meals[0])
    $(".inner-loading-screen").fadeOut(300)

}


function showMealsInfo(meal) {
...
function showContacts() {
    ...
    <div class="container w-75 text-center">
        ...
        <button id="btnSbmt" class="btn btn-outline-danger px-2 mt-3">Submit</button>
    </div>
</div> `
    btnSbmt = document.getElementById("btnSbmt")
